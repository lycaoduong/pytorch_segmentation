...
from networks.efficientnet.model import EfficientNet as EffNet
...
class Segmentator(nn.Module):
    ...
    #         feat = F.interpolate(feature, size=torch.Size([self.img_size, self.img_size]), mode="bilinear", align_corners=True)
    #         feats.append(feat)
